...
description: Generates .enzyme folder digests — flat XML files that let an LLM absorb an entire directory in one read. Invoke when asked to create, update, or manage folder digests.
---
